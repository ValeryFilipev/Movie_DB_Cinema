...
import { Text, TextType } from '../../../components/ui/Typography/Text';
...
storiesOf('Text', module)
  ...
  .add('interactive', () => (
    <Text type={TextType.INTERACTIVE}>This is an interactive text</Text>
  ))
  .add('disabled', () => (
    <Text type={TextType.DISABLED}>This is a disabled text</Text>
  ))
